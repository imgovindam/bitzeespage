...
const Footer = () => {
  return (
    <>
      <div className="border-t-blue-400  bg-blue-600 h-16 px-20 grid grid-cols-12 justify-evenly items-center">
      ...
      <div className="px-16 h-[50vh] cursor-pointer    p-12 bg-gray-700 grid grid-cols-12">
        ...
        <div className="col-span-2  text-start text-white">
          ...
          <div className="mt-4">
            ...
            {/* <motion.div
              ...
              // className="hover:text-white m-1 text-sm"
            >
              <h2 className="pt-1 font-sans"> Terms of use </h2>
            </motion.div> */}
            {/* <motion.div
              whileHover={{ scale: 1.3, originX: 0.2, color: "#add8e6" }}
              // className="hover:text-white m-1 text-sm"
